...
export function useDirectories() {
  ...
  async function addMaterial() {
    try {
      ...
      await loadData();
      alerts.success('Материал успешно добавлен!'); 
    } catch (e) { 
      alerts.error('Ошибка при добавлении материала.'); 
      console.error(e); 
    }
  }
  ...
  async function deleteMaterial(id) {
    ...
    const { isConfirmed } = await alerts.confirmDelete('Удалить материал?');
  ...
  async function addWork() {
    try {
      ...
      await loadData();
      alerts.success('Расценка успешно добавлена!'); 
    } catch (error) { 
      console.error(error); 
      alerts.error('Ошибка добавления работы'); 
    }
  }
  ...
  async function deleteWork(id) {
    ...
    const { isConfirmed } = await alerts.confirmDelete('Удалить расценку на работу?');
